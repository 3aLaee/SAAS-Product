        ...
        <Col md={6} className="text-right">
          <div className="banner-right">
            ...
            <p className="banner-paragraph">
               حان وقت التغيير!! لأول مرة في المغرب اكتشف منتجات متنوعة ومتاحة من تجار الجملة المختلفين في مكان واحد و بالمجان
            </p>
            ...
            <div className="banner-mark-container">
              ...
              <div className="banner-mark">
                <span className="banner-mark-text"> تتبع شحنتك لتفادي التأخير و ضاعف أرقامك في التجارة الإلكترونية </span>
                <div className="green-mark"></div>
              </div>
